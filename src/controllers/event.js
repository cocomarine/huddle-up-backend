const { createEntry, getAllEntry, getEntryById, updateEntryById, deleteEntryById, getVotesById } = require('./helpers');
...
const getEventVotesById = (_, res) => getVotesById(res, 'event', id);

module.exports = { createEvent, getAllEvents, getEventById, updateEventById, deleteEventById, getEventVotesById };
